...
window.audioAnalyzerState = {
    ...
    difficulty: 'beginner', // 'beginner', 'amateur', 'elite'
    tolerances: {
        beginner: { dashRatio: 1.6, charTimeout: 3.5, spaceForce: 2.2, wordSpace: 5.5 },
        amateur:  { dashRatio: 1.8, charTimeout: 2.5, spaceForce: 1.8, wordSpace: 6.0 },
        elite:    { dashRatio: 2.2, charTimeout: 1.8, spaceForce: 1.5, wordSpace: 7.0 }
    },

...
if (els.updateBannerBtn) els.updateBannerBtn.onclick = window.forceAppUpdate;
if (els.gameModeInput) els.gameModeInput.onchange = checkGameTypeUI;
if (els.gameTypeInput) els.gameTypeInput.onchange = checkGameTypeUI;

...
window.shareAppToFriends = function() {
    const text = encodeURIComponent("📻 Vieni a sfidarmi su Telegrafia! Vediamo chi è più veloce a decodificare il Morse 🚀");
    const url = `https://t.me/share/url?url=https://t.me/${BOT_USERNAME}/${WEBAPP_NAME}&text=${text}`;

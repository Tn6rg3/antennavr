...
window.finishGame = function() {
    ...
    else if (roomCode && roomCode.startsWith(\"TRN_\")) { activeTab = \"room\"; if (typeof window.showLeaderboardTab === 'function') window.showLeaderboardTab('tabRoomBtn'); if (typeof window.listenToRoomLeaderboard === 'function') window.listenToRoomLeaderboard(); }
    else if (isSinglePlayer && currentMode === 'callsign') { activeTab = \"cwfreak\"; if (typeof window.showLeaderboardTab === 'function') window.showLeaderboardTab('tabGlobalCWFreakBtn'); }
    else if (isSinglePlayer && currentMode === 'pingpong') { activeTab = \"pingpong\"; if (typeof window.showLeaderboardTab === 'function') window.showLeaderboardTab('tabGlobalPingPongBtn'); }
    else if (isSinglePlayer && currentMode === 'quiz') { activeTab = \"quiz_single\"; if (typeof window.showLeaderboardTab === 'function') window.showLeaderboardTab('tabGlobalQuizSingleBtn'); }
    else if (isSinglePlayer && currentMode === 'chars') { activeTab = \"chars_single\"; if (typeof window.showLeaderboardTab === 'function') window.showLeaderboardTab('tabGlobalCharsSingleBtn'); }
    else if (isSinglePlayer) { activeTab = \"std_single\"; if (typeof window.showLeaderboardTab === 'function') window.showLeaderboardTab('tabGlobalStandardSingleBtn'); }
    else { activeTab = \"room\"; if (typeof window.showLeaderboardTab === 'function') window.showLeaderboardTab('tabRoomBtn'); if (typeof window.listenToRoomLeaderboard === 'function') window.listenToRoomLeaderboard(); }
};
    ...
    if (document.hidden) {
        ...
        if (gameRunning && window.lostFocusDuringWord) {
            ...
            if (currentMode === 'conquest') {
                ...
                if (typeof window.submitQuizAnswer === 'function') window.submitQuizAnswer(-1);
